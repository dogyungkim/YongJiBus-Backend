...
// jsonFactory,
// new
// InputStreamReader(GmailOAuthTokenGetter.class.getResourceAsStream(CREDENTIALS_FILE_PATH)));
...
// .setPort(8888).build();
// var credential = new
// com.google.api.client.extensions.java6.auth.oauth2.AuthorizationCodeInstalledApp(flow,
